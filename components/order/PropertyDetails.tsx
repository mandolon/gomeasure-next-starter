...
export default function PropertyDetails({ formData, onUpdate, onNext }: PropertyDetailsProps) {
  ...
  const handleAreaFromMap = (area: number) => {
    ...
    if (scope === 'interior') {
      ...
      // For both, split evenly or add to exterior by default
  ...
  return (
    <div>
            ...
            <div>
              ...
              <div className="area-row">
                <input 
                  ...
                  onChange={(e) => handleInputChange('areaInt', Number(e.target.value))}
                />
            ...
            <div>
              ...
              <div className="area-row">
                <input 
                  ...
                  onChange={(e) => handleInputChange('areaExt', Number(e.target.value))}
                />
                <span className="unit">sq&nbsp;ft</span>
              </div>
            </div>
              ...
              <div className="area-row area-row--split">
                <label className="mini-field" htmlFor="area-both-int">
                  ...
                  <input 
                    ...
                    onChange={(e) => handleInputChange('areaBothInt', Number(e.target.value))}
                  />
                </label>
                ...
                <label className="mini-field" htmlFor="area-both-ext">
                  ...
                  <input 
                    ...
                    onChange={(e) => handleInputChange('areaBothExt', Number(e.target.value))}
                  />
                </label>
              </div>
            </div>
      ...
      <div className="hint">
        <a href="#" className="underline" onClick={(e) => { e.preventDefault(); alert('Property size estimation guide would go here'); }}>
